    ...
    class Program
    {
        static void Main(string[] args)
        {
            int[,] array =
            {
                ...
                {10, 11, 12, 13, 14 },
                { 1, 3,3,4,5 } };
            znajdz(array, out int row1, out int row2);
            Console.WriteLine($"podobne wiersze: {row1} i {row2}");
        }
        static void znajdz(int[,] array, out int row1, out int row2 )
        {
            row1 = 0;
            row2 = 0;
            ...
            for (int i = 0; i < iloscWierszy; i++)
            {
                ...
                {
                    long roznica = Roznica(array, i, j);
        ...
        static long Roznica(int[,] array, int i, int j)
        {
            int iloscKolumn = array.GetLength(1);
            long roznica = 0;
